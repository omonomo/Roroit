...
最新版 v1.2.0 (2025-10-01)

| リンク                                                                                                      | 説明                                            |
| ----------------------------------------------------------------------------------------------------------- | ----------------------------------------------- |
| [フォント (Roroit)](https://github.com/omonomo/Roroit/releases/download/v1.2.0/Roroit_v1.2.0.zip)           | 通常版。半角幅が全角の1/2。                     |
| [フォント (RoroitLoose)](https://github.com/omonomo/Roroit/releases/download/v1.2.0/RoroitLoose_v1.2.0.zip) | 文字間隔ゆるい版。半角幅が全角の9/16。          |
| [ソースコード](https://github.com/omonomo/Roroit/archive/refs/tags/v1.2.0.zip)                              | 使用方法は[下の方](#基本的な使い方)にあります。 |
...
- Cyroit 同様、半角英数文字の大きさや縦横比を通常版から変更しています。Loose 版のほうが素の Roboto Mono に近い形状をしています。
